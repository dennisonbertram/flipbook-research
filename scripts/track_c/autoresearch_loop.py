    ...
    *,
    ...
    return Experiment(
        ...
        notes=(
            ...
            f"amount {amount:g}, flow scale {flow_scale:g}, {steps} steps, freq{freq_bands}{clip_note}{l1_note}{grad_note}{seed_note}{detail_note}{source_coord_note}{neighborhood_note}{text_note}{target_note}{mid_note}{flow_loss_note}{oracle_note}{curriculum_note}{endpoint_note}."
        ),
        args=general_visual_motion_args(
            label,
